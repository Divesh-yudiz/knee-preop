...
export class AddLines {
    ...
    constructor(scene, landmarks) {
        ...
        this.updatebutton.addEventListener("click", this.createStaticLines);
    ...
    // createLines = async () => {
    //     const createdLines = []; // Array to store created lines
    ...
    //                 line.renderOrder = 0;
    //                 this.scene.add(line);
    //                 createdLines.push(line); // Store the created line
    //             }
    //         }
    //         // Call createPlane after all lines have been created, passing the created lines
